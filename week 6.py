...
def _(features_list, mo, train_gini, validate_gini):
    ...
    Валідаційна вибірка: {validate_gini:.4f} (0.5703) (0.5599)
...
def _(
    ...
    model = xgb.XGBClassifier(objective='binary:logistic', random_state=32, use_label_encoder=False, eval_metric='logloss')
...
@app.cell
def _(test_df, train_df, validate_df):
    train_df.to_pickle("train_df_full.pkl")
    validate_df.to_pickle("validate_df_full.pkl")
